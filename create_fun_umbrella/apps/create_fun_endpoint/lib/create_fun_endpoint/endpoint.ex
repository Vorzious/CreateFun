defmodule CreateFunEndpoint.Endpoint do
  use Phoenix.Endpoint, otp_app: :create_fun_endpoint

  # socket "/socket", CreateFunEndpoint.UserSocket
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_create_fun_endpoint_key",
    signing_salt: "XlkupJTx"

  plug CreateFunEndpoint.Reroute
